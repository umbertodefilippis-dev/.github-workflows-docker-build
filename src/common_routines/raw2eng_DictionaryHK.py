...
def raw2eng_DictionaryHK(t,hk_eng,schema_path, output_path, config):
    ...
    # Populate hk_cal with ACC_JUICE_X, ACC_JUICE_Y, ACC_JUICE_Z, TIME_UTC, TIME_OBT data
    hk_cal = {'field': [{}]}

    # Assign values to the structure
    hk_cal['field'][count - 1]['TIME_UTC']  = {'data': np.char.mod('%s', np.asarray(t))}
    hk_cal['field'][count - 1]['TIME_OBT'] = {'data': [spice.sce2s(spice.bodn2c('JUICE'), spice.str2et(str(time))) for time in hk_cal['field'][count-1]['TIME_UTC']['data']]}
    hk_cal['field'][count - 1]['MODE'] = {'data': hk_eng['MODE']}
    hk_cal['field'][count - 1]['LOW_RATE'] = {'data': hk_eng['LOW_RATE']}
    hk_cal['field'][count - 1]['PRIM_CURR'] = {'data': hk_eng['PRIM_CURR']}
    hk_cal['field'][count - 1]['TEMP_FEE'] = {'data': hk_eng['TEMP_FEE']}
    hk_cal['field'][count - 1]['TEMP_IDA_FEE_HOTSPOT'] = {'data': hk_eng['TEMP_IDA_FEE_HOTSPOT']}
    hk_cal['field'][count - 1]['TEMP_IDA_FEE_DIGITAL'] = {'data': hk_eng['TEMP_IDA_FEE_DIGITAL']}
    hk_cal['field'][count - 1]['TEMP_IDA_BOUNDARY'] = {'data': hk_eng['TEMP_IDA_BOUNDARY']}
    hk_cal['field'][count - 1]['TEMP_ACC_0'] = {'data': hk_eng['TEMP_ACC_0']}
    hk_cal['field'][count - 1]['TEMP_ACC_1'] = {'data': hk_eng['TEMP_ACC_1']}
    hk_cal['field'][count - 1]['TEMP_ACC_2'] = {'data': hk_eng['TEMP_ACC_2']}
    hk_cal['field'][count - 1]['PWR_TEMP'] = {'data': hk_eng['PWR_TEMP']}
    hk_cal['field'][count - 1]['DELTA_TEMP_FEE'] = {'data': hk_eng['DELTA_TEMP_FEE']}
    hk_cal['field'][count - 1]['DELTA_TEMP_ACC_0'] = {'data': hk_eng['DELTA_TEMP_ACC_0']}
    hk_cal['field'][count - 1]['DELTA_TEMP_ACC_1'] = {'data': hk_eng['DELTA_TEMP_ACC_1']}
    hk_cal['field'][count - 1]['DELTA_TEMP_ACC_2'] = {'data': hk_eng['DELTA_TEMP_ACC_2']}
    hk_cal['field'][count - 1]['HEAT_STAT_FEE'] = {'data': hk_eng['HEAT_STAT_FEE']}
    hk_cal['field'][count - 1]['HEAT_STAT_ACC0'] = {'data': hk_eng['HEAT_STAT_ACC0']}
    hk_cal['field'][count - 1]['HEAT_STAT_ACC1'] = {'data': hk_eng['HEAT_STAT_ACC1']}
    hk_cal['field'][count - 1]['HEAT_STAT_ACC2'] = {'data': hk_eng['HEAT_STAT_ACC2']}
    hk_cal['field'][count - 1]['HEAT_CURR_FEE'] = {'data': hk_eng['HEAT_CURR_FEE']}
    hk_cal['field'][count - 1]['HEAT_CURR_ACC0'] = {'data': hk_eng['HEAT_CURR_ACC0']}
    hk_cal['field'][count - 1]['HEAT_CURR_ACC1'] = {'data': hk_eng['HEAT_CURR_ACC1']}
    hk_cal['field'][count - 1]['HEAT_CURR_ACC2'] = {'data': hk_eng['HEAT_CURR_ACC2']}
    hk_cal['field'][count - 1]['TEMP_REACH_ACC0'] = {'data': hk_eng['TEMP_REACH_ACC0']}
    hk_cal['field'][count - 1]['TEMP_REACH_ACC1'] = {'data': hk_eng['TEMP_REACH_ACC1']}
    hk_cal['field'][count - 1]['TEMP_REACH_ACC2'] = {'data': hk_eng['TEMP_REACH_ACC2']}
    hk_cal['field'][count - 1]['TR_FEE'] = {'data': hk_eng['TR_FEE']}
    hk_cal['field'][count - 1]['ICE_140V'] = {'data': hk_eng['ICE_140V']} 
    hk_cal['field'][count - 1]['ICE_3V'] = {'data': hk_eng['ICE_3V']}
    
    # Set file start and stop times
    hk_cal['fileStartTime'] = [str(t[0])]
    hk_cal['fileStopTime'] = [str(t[-1])]
    hk_cal['fileNum'] = count
    hk_cal['fileName'] = config['Mission_Information']['filename']
    hk_cal['file_size'] = config['Mission_Information']['filesize']
    hk_cal['records'] =  len(hk_eng['TIME_OBT'])
    ...
    def fill_xml_with_computed_values(schema_path, output_path, hk_cal, config):
        ...
        hk_cal['lid'] = 'urn:esa:psa:juice_haa:data_calibrated:' + config['Mission_Information']['filename']
        # Parse the XML file
        ...
        time_coords.find(".//pds:start_date_time", namespaces).text = hk_cal['fileStartTime'][0]
        time_coords.find(".//pds:stop_date_time", namespaces).text = hk_cal['fileStopTime'][0]
