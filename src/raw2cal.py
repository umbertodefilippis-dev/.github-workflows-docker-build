...
parser.add_argument('-i', '--input', default='/app/inputs/pds/', help='Path to input data pack (default: /app/inputs/pds/)')
parser.add_argument('-o', '--output', default='/app/outputs/', help='Path to output folder (default: /app/outputs/)')
parser.add_argument('-l', '--log', default="/app/logs/", help='Path to log folder (default: /app/logs/)')
